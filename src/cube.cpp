...
Hypercube::Hypercube(MNIST input, MNIST query, string output, int d, int M, int p, int N, int R) {
...
void Hypercube::AssignInputToVertices() {
...
vector<Image> Hypercube::GetNearestNeighborsCandidates(vector<vector<Vertex>> vertices_by_hamming_distance) {
...
set<Image, ImageComparator> Hypercube::FindAproximateNearestNeighbors(Image query_image)
{
...
set<Image, ImageComparator> Hypercube::BruteForceNearestNeighbors(Image query_image)
{
...
set<Image, ImageComparator> Hypercube::RadiusSearch(Image query_image)
{
...
void Hypercube::WriteToFile(Image query_image, set<Image, ImageComparator> nearest_neighbors_hypercube, set<Image, ImageComparator> nearest_neighbors_brute_force, set<Image, ImageComparator> neighbors_in_radius, double hypercube_time, double brute_time) {
