...
int main(int argc, char *argv[])
{
    ...
    string conf_file;      // File containing the configuration.
    string method;         // Selected assignment method.
    bool complete;         // Completion flag.
    int no_clusters;       // Number of clusters to use.
    int no_hash_tables;    // Number of hash tables for LSH.
    int no_hash_functions; // Number of hash function for LSH.
    int no_max_hypercubes; // Number of Hypercubes for CUBE.
    int no_dim_hypercubes; // Number of Dimensions for CUBE.
    int no_probes;         // Number of Probes for CUBE.
    ...
    // Parse the configuration contents using rapidyaml.h functionality.
    ...
    Cluster cluster = Cluster(no_clusters, no_hash_tables, no_hash_functions, no_max_hypercubes, no_dim_hypercubes, no_probes, input, method);
